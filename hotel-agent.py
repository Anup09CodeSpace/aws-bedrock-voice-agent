...
if __name__ == "__main__":
    ...
    os.environ["AWS_ACCESS_KEY_ID"] = "##USER AWS_ACCESS_KEY_ID##"
    os.environ["AWS_SECRET_ACCESS_KEY"] = "##USER AWS_SECRET_ACCESS_KEY##"
    os.environ["AWS_DEFAULT_REGION"] = "##USER REGION##"
